...
class IndexApplicationRequestTest extends ValidationTestCase
{
    ...
    {
        $data = [
            'searchable' => ['id', 'firstname', 'lastname', 'birthday', 'email', 'img_receipt', 'product', 'shop', 'whence.name', 'created_at', 'legal_1', 'legal_2', 'legal_3', 'legal_4', 'contest', 'title', 'message', 'img_tip', 'video_url', 'video_type', 'video_id', 'video_image_id'],
            'offset' => 0,
            'limit' => 10,
            'sort' => 'id',
            'order' => 'asc',
